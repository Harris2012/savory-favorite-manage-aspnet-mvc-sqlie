...
namespace SavoryFavorite.Repository.Sqlite
{
    public class SqliteCategoryRepository : ICategoryRepository
    {
        ...
        {
            string sql = "select id as Id, category_id as CategoryId, category_name as CategoryName, description as Description from category where Id = ?";
        ...
        {
            string sql = "select id as Id, category_id as CategoryId, category_name as CategoryName, description as Description from category";
        ...
        {
            string sql = "select id as Id, category_id as CategoryId, category_name as CategoryName, description as Description from category limit @Start, @Count";
