//新建数据库
function FavoriteUpdateController($scope, $state, $stateParams, SavoryFavoriteManageService) {
    ...
    $scope.confirmUpdate = function () {
        ...
        SavoryFavoriteManageService.favorite_update(request).then(favorite_update_callback)
    }

    {
        ...
        SavoryFavoriteManageService.favorite_editable(request).then(favorite_editable_callback);
    }
}
