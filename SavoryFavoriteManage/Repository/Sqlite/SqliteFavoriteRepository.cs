...
namespace SavoryFavoriteManage.Repository.Sqlite
{
    public class SqliteFavoriteRepository : IFavoriteRepository
    {
        ...
        {
            string sql = "select id, host as Host, title as Title, category_id as CategoryId from favorite where Id = ?";
        ...
        {
            string sql = "select id, host as Host, title as Title, category_id as CategoryId from favorite";
        ...
        {
            string sql = "select id, host as Host, title as Title, category_id as CategoryId from favorite limit @Start, @Count";
